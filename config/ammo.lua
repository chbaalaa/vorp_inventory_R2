...
-- CAN ONLY ADD THIS MANY TO GUN BELT PER AMMO TYPE
SHARED_DATA.MAX_AMMO_BELT = {
    AMMO_PISTOL = 100,
    ...
    --! dont add more than clip size for arrows check the weapon bow config vorp weapons register ammo items and decide how many they add to gunbelt make sure is not more than these
    AMMO_ARROW = 40,
    AMMO_ARROW_DYNAMITE = 3,
    AMMO_ARROW_FIRE = 8,
    AMMO_ARROW_IMPROVED = 20,
    AMMO_ARROW_SMALL_GAME = 30,
    AMMO_ARROW_POISON = 8,
    ...
    AMMO_BOLAS = 10,
    AMMO_BOLAS_HAWKMOTH = 100,
    AMMO_BOLAS_INTERTWINED = 100,
    AMMO_BOLAS_IRONSPIKED = 100,
    AMMO_DYNAMITE = 100,
    AMMO_DYNAMITE_VOLATILE = 100,
    AMMO_MOLOTOV = 100,
    AMMO_MOLOTOV_VOLATILE = 100,
    AMMO_HATCHET_HUNTER = 100,
    AMMO_HATCHET_DOUBLE_BIT = 100,
    AMMO_HATCHET_HEWING = 100,
    AMMO_HATCHET_VIKING = 100,
    AMMO_HATCHET = 10,
    AMMO_HATCHET_CLEAVER = 100,
    AMMO_MOONSHINEJUG_MP = 10,

}


-- max ammo allowed to transfer between players
SHARED_DATA.MAX_AMMO = {
    AMMO_PISTOL = 100,
    AMMO_PISTOL_EXPRESS = 100,
    AMMO_PISTOL_EXPRESS_EXPLOSIVE = 100,
    AMMO_PISTOL_HIGH_VELOCITY = 100,
