...
SHARED_DATA.WEAPONS                      = {
    ...
    WEAPON_BOW = {
        ...
        DefaultClipSize = 40, -- for bow you can change this is how many arrows it will be allowd to be added, vorp wepons register ammo items and decide how many they add to gunbelt
        NoSerialNumber = true,
        NoDegradation = true, -- DONT TOUCH THIS THIS WEAPON DOESNT DEGRADE NATIVELY
    },
